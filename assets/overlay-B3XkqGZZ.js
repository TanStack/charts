import{r as e}from"./day-C2hW9sXQ.js";var t=864e5,n=[`Product`,`Design`,`Marketing`,`Engineering`],r=[f(2025,0,1),f(2025,2,1)],i=f(2025,1,3),a=f(2025,1,12);function o(e=0,t=a){let n=e%2==1;return[{id:`discovery`,label:`Discovery`,lane:`Product`,start:f(2025,0,4),end:f(2025,0,13)},{id:`design`,label:`Design system`,lane:`Design`,start:f(2025,0,10),end:f(2025,0,n?26:24)},{id:`campaign`,label:`Campaign`,lane:`Marketing`,start:f(2025,0,n?19:20),end:f(2025,1,7)},{id:`release`,label:`Release window`,lane:`Engineering`,start:i,end:t}]}function s(e){return e.toISOString().slice(0,10)}function c(e){let t=e.startsWith(`date:`)?e.slice(5):``;if(!/^\d{4}-\d{2}-\d{2}$/.test(t))return null;let n=new Date(`${t}T00:00:00.000Z`);return!Number.isFinite(n.getTime())||s(n)!==t||n<r[0]||n>r[1]?null:n}function l(n){let a=i.getTime()+t,o=Math.min(r[1].getTime(),Math.max(a,e.round(n).getTime()));return new Date(o)}function u(e,n){return(n.getTime()-e.getTime())/t}function d(e){return e===`release`?`#f97316`:`#2563eb`}function f(e,t,n){return new Date(Date.UTC(e,t,n))}function p(e,t,n){let r=e.ownerDocument,i=r.createElement(`style`);i.textContent=`
