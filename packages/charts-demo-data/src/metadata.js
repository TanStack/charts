...
export const demoDatasetMetadata = [
  {id: "aapl", title: "Apple daily stock prices", specifier: "@charts-poc/demo-data/aapl", format: "CSV", records: 1260, fields: [
  "Date",
  "Open",
  "High",
  "Low",
  ...
  {id: "alphabet", title: "English letter frequencies", specifier: "@charts-poc/demo-data/alphabet", format: "CSV", records: 26, fields: [
  "letter",
  "frequency",
], schema: [
  {name: "letter", types: [
  ...
  {id: "cars", title: "1983 ASA automobile data", specifier: "@charts-poc/demo-data/cars", format: "CSV", records: 406, fields: [
  "name",
  "economy (mpg)",
  "cylinders",
  "displacement (cc)",
  ...
  {id: "citywages", title: "U.S. metropolitan wage inequality", specifier: "@charts-poc/demo-data/citywages", format: "CSV", records: 195, fields: [
  "Metro",
  "POP_1980",
  "LPOP_1980",
  "R90_10_1980",
  ...
  {id: "diamonds", title: "ggplot2 diamonds", specifier: "@charts-poc/demo-data/diamonds", format: "CSV", records: 53940, fields: [
  "carat",
  "cut",
  "color",
  "clarity",
  ...
  {id: "flare", title: "Flare package hierarchy", specifier: "@charts-poc/demo-data/flare", format: "CSV", records: 252, fields: [
  "name",
  "size",
], schema: [
  {name: "name", types: [
  ...
  {id: "industries", title: "U.S. industry unemployment", specifier: "@charts-poc/demo-data/industries", format: "CSV", records: 1708, fields: [
  "date",
  "industry",
  "unemployed",
], schema: [
  ...
  {id: "miserables", title: "Les Misérables character network", specifier: "@charts-poc/demo-data/miserables", format: "JSON", records: 331, fields: [
  "nodes",
  "links",
], schema: [
  {name: "nodes", types: [
  ...
  {id: "olympians", title: "2016 Summer Olympians", specifier: "@charts-poc/demo-data/olympians", format: "CSV", records: 11538, fields: [
  "id",
  "name",
  "nationality",
  "sex",
  ...
  {id: "penguins", title: "Palmer penguins", specifier: "@charts-poc/demo-data/penguins", format: "CSV", records: 344, fields: [
  "species",
  "island",
  "culmen_length_mm",
  "culmen_depth_mm",
  ...
  {id: "pizza", title: "Pizza Paradise orders", specifier: "@charts-poc/demo-data/pizza", format: "CSV", records: 29853, fields: [
  "order_date",
  "day_of_week",
  "category",
  "name",
  ...
  {id: "weather", title: "Seattle weather observations", specifier: "@charts-poc/demo-data/weather", format: "CSV", records: 2922, fields: [
  "location",
  "date",
  "precipitation",
  "temp_max",
  ...
  {id: "westport-house", title: "Westport House second-floor plan", specifier: "@charts-poc/demo-data/westport-house", format: "JSON", records: 121, fields: [
  "type",
  "features",
], schema: [
  {name: "type", types: [
