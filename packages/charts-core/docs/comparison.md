...
| -------------------------------------------------------------------------------------- | -------------------- | ------------------- |
| [TanStack Charts](./overview.md)                                                       | `@tanstack/charts`   | workspace `093f81c` |
...
at page render time. The measured TanStack workspace revision is `093f81c`.
...
| --------------- | ------------------: | -----------------: |
| TanStack Charts |     26.12–31.04 KiB |                  — |
