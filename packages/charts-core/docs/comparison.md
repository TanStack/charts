...
The latest published TanStack Charts release is `0.12.0`, while this page
...
| -------------------------------------------------------------------------------------- | -------------------- | ------------------- |
| [TanStack Charts](./overview.md)                                                       | `@tanstack/charts`   | workspace `56567ec` |
...
at page render time. The measured TanStack workspace revision is `56567ec`.
...
- [Standard comparison protocol](https://github.com/TanStack/charts/blob/v0.12.0/benchmarks/comparison/README.md)
- [Current tracked bundle baseline](https://github.com/TanStack/charts/blob/main/benchmarks/comparison/bundle-baseline.json)
- [Pinned release-source bundle baseline](https://github.com/TanStack/charts/blob/v0.12.0/benchmarks/comparison/bundle-baseline.json)
- [Stress protocol](https://github.com/TanStack/charts/blob/v0.12.0/benchmarks/comparison/stress/README.md)
- [Catalog conformance protocol](https://github.com/TanStack/charts/blob/v0.12.0/benchmarks/conformance/README.md)
