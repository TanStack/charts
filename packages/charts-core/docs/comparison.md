...
TanStack Charts `0.6.1` is a pre-alpha release. Its results on this page measure
...
- [Standard comparison protocol](https://github.com/TanStack/charts/blob/v0.6.1/benchmarks/comparison/README.md)
- [Current tracked bundle baseline](https://github.com/TanStack/charts/blob/main/benchmarks/comparison/bundle-baseline.json)
- [0.6.1 tagged bundle baseline](https://github.com/TanStack/charts/blob/v0.6.1/benchmarks/comparison/bundle-baseline.json)
- [Stress protocol](https://github.com/TanStack/charts/blob/v0.6.1/benchmarks/comparison/stress/README.md)
- [Catalog conformance protocol](https://github.com/TanStack/charts/blob/v0.6.1/benchmarks/conformance/README.md)
