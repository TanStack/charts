...
| -------------------------------------------------------------------------------------- | -------------------- | ------------------- |
| [TanStack Charts](./overview.md)                                                       | `@tanstack/charts`   | workspace `8ff72b9` |
...
at page render time. The measured TanStack workspace revision is `8ff72b9`.
...
| --------------- | ------------------: | -----------------: |
| TanStack Charts |     27.10–32.13 KiB |                  — |
