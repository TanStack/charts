...
The latest published TanStack Charts release is `0.7.2`, while this page
...
| -------------------------------------------------------------------------------------- | -------------------- | ------------------- |
| [TanStack Charts](./overview.md)                                                       | `@tanstack/charts`   | workspace `7daa216` |
...
at page render time. The measured TanStack workspace revision is `7daa216`.
...
| ------------------ | -------------------------------------- | -----------------: | ---------------------------------------------------------- |
| TanStack Charts    | 37.28–43.23 KiB                        |                  — | Controlled suite                                           |
...
The catalog corpus contains 110 TanStack/reference pairs: 76 sourced from
Observable Plot, 23 from Recharts, and 11 from Apache ECharts. Nineteen pairs
...
- [Standard comparison protocol](https://github.com/TanStack/charts/blob/v0.7.2/benchmarks/comparison/README.md)
- [Current tracked bundle baseline](https://github.com/TanStack/charts/blob/main/benchmarks/comparison/bundle-baseline.json)
- [Pinned release-source bundle baseline](https://github.com/TanStack/charts/blob/v0.7.2/benchmarks/comparison/bundle-baseline.json)
- [Stress protocol](https://github.com/TanStack/charts/blob/v0.7.2/benchmarks/comparison/stress/README.md)
- [Catalog conformance protocol](https://github.com/TanStack/charts/blob/v0.7.2/benchmarks/conformance/README.md)
