...
The latest public pre-alpha release is TanStack Charts `0.7.2`. Repository docs,
examples, and the catalog follow unreleased `main` and may include contracts not
available in `0.7.2`; documentation at the verified release source revision is
...
**Framework position:** The core is framework-independent. `0.7.2` ships thin
...
| Is it ready for production?                                   | Not yet. `0.7.2` is a public pre-alpha release. Marketing must keep the documented release gates visible until they close.                                                                                                                                                                                                                                                               |
...
- Conversion: Install `0.7.2`, read its release-source docs, explore the catalog,
  and report friction.
...
**Primary conversion today:** Install `0.7.2` and complete the first chart.
