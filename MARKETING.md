...
TanStack Charts `0.6.2` is a public pre-alpha release. The docs, examples, and
catalog describe the same definition, behavior, scale, tooltip, and adapter
contracts available in `0.6.2`. Marketing must keep the pre-alpha status
...
**Framework position:** The core is framework-independent. `0.6.2` ships thin
...
| Is it ready for production?                                   | Not yet. `0.6.2` is a public pre-alpha release. Marketing must keep the documented release gates visible until they close.                                                                                                                                                                                                                                                               |
...
- Conversion: Install `0.6.2`, read the matching docs, explore the catalog,
  and report friction.
...
**Primary conversion today:** Install `0.6.2` and complete the first chart.
