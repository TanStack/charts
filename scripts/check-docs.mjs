...
console.log(
  `Documentation contract passed for ${result.markdownFiles.length} pages, ${result.catalogExamples.length} catalog examples, and ${result.standaloneExamples.length} executable examples.`,
)
