...
import { shadcnColors, shadcnRadarFilled } from '@charts-poc/demo-data/shadcn'
import './styles.css'
const twoSeries = ['desktop', 'mobile'] as const
function createDefinition() {
  const rows = shadcnRadarFilled
  ...
  const guides = [
    radialGrid({
      ...
      stroke: 'transparent',
      strokeOpacity: 0,
      ...{ fill: shadcnColors[0], fillOpacity: 0.2 },
      ...{},
    }),
    angleGrid({
      values: months,
      ...
      <article className="sc-card sc-default" style={{ width }}>
        <header className="sc-card-header" style={{ paddingBottom: 16 }}>
          <div className="sc-card-heading">
            <h2>Radar Chart - Grid Circle Filled</h2>
