...
| `@tanstack/charts/focus/guide`         | `focusGuideX`, `focusGuideY`, and focus-guide option types                                                                                                                                                                      |
...
| `@tanstack/charts/interaction/signal`  | `controlledSignal`, `ControlledSignal`                                                                                                                                                                                          |
| `@tanstack/charts/interaction/zoom`    | `zoomX`, `ZoomXValue`, `ZoomXWindow`, `ZoomXSource`, `ZoomXAction`, `ZoomXChange`, and `ZoomXOptions`                                                                                                                           |
| `@tanstack/charts/legend`              | `colorLegend`, `colorGradientLegend`, `interactiveColorLegend`, and legend option/change types                                                                                                                                  |
...
| `@tanstack/charts/selection`           | `keyedSelection`, `whenSelected`, `KeyedSelectionChange`, `KeyedSelectionOptions`, and `KeyedSelection`                                                                                                                         |
